...
public class ShimmerLayout extends FrameLayout {
    ...
    private static final byte DEFAULT_ANGLE = 10;
    ...
    public ShimmerLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        try {
            ...
            shimmerColor = a.getColor(R.styleable.ShimmerLayout_shimmer_color, getColor(R.color.gray_light));
            ...
            gradientCenterColorWidth = a.getFloat(R.styleable.ShimmerLayout_shimmer_gradient_center_color_width, 0.3F);
